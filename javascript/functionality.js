		...
		//This function allows users to click on the image to know what hobbies they represent
		//By far, the most successful piece of coding I have done since past 2 years!!!!
		function myFunction(){
		if(document.getElementById('slide').src === slideimages[0].src)
				alert("IIT's basketball team beats UIC by 30 points! Go hawks.")
		if(document.getElementById('slide').src === slideimages[1].src)
				alert("IIT presenting a new course to the ITM program. A course about SaaS")
		if(document.getElementById('slide').src === slideimages[2].src)
				alert("Scholarship opportunity for students looking for some extra help paying for Tuition.")
		if(document.getElementById('slide').src === slideimages[3].src)
				alert("IIT's engineering department is working on drones that will follow lasers for direction.")
		if(document.getElementById('slide').src === slideimages[4].src)
				alert("IIT expanding the workout fitness center! A plan that was must needed!")
		}
